...
//   const [previousWinningCountryNumbers, setPreviousWinningCountryNumbers] = useState([]);
...
//     const matchingNumbers = game.selectedNumbers.filter((number, index) =>
//     previousWinningNumbers[index] === number
//     );
  

//       console.log(`You have matched ${matchingNumbers.length} numbers at the same positions: ${matchingNumbers.join(', ')}`);
...
//    <Text    style={styles.matchedNumberText}>  You have matched {matchNumbers} Numbers </Text>
...
//    <Text    style={styles.priceText}>  {CountrySymbol}{game.prizeMoney}  </Text>
